...
#SBATCH --gres=gpu:1
#SBATCH --job-name=train_t2t_controlsplit
#SBATCH --output=train_t2t_controlsplit.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    ...
    --lr 0.1 \
    --num_ref 8 \
    --control_mode "length:syntax:split:ppdb:predict_split" \
    --max_ppdb_len 100 \
    ...
    --init_ckpt_path "/zfs1/hdaqing/saz31/ts_exp_bk/t2t_controlsplit/log/model.ckpt-830000" \