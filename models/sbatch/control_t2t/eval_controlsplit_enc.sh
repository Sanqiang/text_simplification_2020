...
#SBATCH --job-name=eval_t2t_controlsplit_enc
#SBATCH --output=eval_t2t_controlsplit_enc.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    ...
    --max_src_len 150 \
    --max_trg_len 150 \
    --control_mode "length|0.5:syntax|0.0:split|1.0:ppdb|1.0:predict_split:encoder" \
    --max_ppdb_len 100 \
    --beam_search_size 1 \
    --lr 0.1 \
    --num_ref 8 \
