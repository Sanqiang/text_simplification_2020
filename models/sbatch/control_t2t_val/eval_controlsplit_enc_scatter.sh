...
#SBATCH --job-name=eval_t2t_controlsplit_enc_scatter_val
#SBATCH --output=eval_t2t_controlsplit_enc_scatter_val.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    ...
    --max_src_len 150 \
    --max_trg_len 150 \
    --control_mode "length|0.5:syntax|1.0:split|1.0:ppdb|1.0:predict:encoder:val" \
    --max_ppdb_len 100 \
    --beam_search_size 1 \
    --lr 0.1 \
    --num_ref 8 \
