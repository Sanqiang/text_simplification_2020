...
#SBATCH --gres=gpu:1
#SBATCH --job-name=t_wkl_ctrf_sl
#SBATCH --output=t_wkl_ctrf_sl.out
#SBATCH --nodes=1
...
srun python ../../ts_model/run.py \
    ...
    --train_tfexample "/zfs1/hdaqing/saz31/dataset/example_v5_val/shard_wikilarge_*.example" \
    --train_batch_size 32 \
    --dimension 256 \
    --num_hidden_layers 6 \
    --num_heads 4 \
    ...
    --lr 0.15 \
    --num_ref 8 \
    --control_mode "sent_length|1.0:val:scatter_ppdb:flatten" \
    --max_ppdb_len 100 \
